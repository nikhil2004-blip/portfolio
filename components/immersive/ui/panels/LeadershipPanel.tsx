                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-1 mb-2">
                  <div className="flex items-center gap-3">
                    <div style={{ color: accentColor }}>
                      {exp.type === 'work' ? <Icon icon="pixelarticons:briefcase" width={16} /> : <Icon icon="pixelarticons:git-branch" width={16} />}
                    </div>
                    {exp.badge && (
            ...
            return (
              ...
              >
                <div className="mb-2" style={{ color: accentColor }}>
                  {AchIcon.length > 2 ? <Icon icon={`pixelarticons:${AchIcon}`} width={24} /> : a.icon}
                </div>
