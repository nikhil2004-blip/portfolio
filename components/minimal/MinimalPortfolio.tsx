  ...
  return (
    <>
      ...
      <div className="bg-zinc-950 min-h-screen text-zinc-400 font-sans selection:bg-zinc-200 selection:text-zinc-900 pb-12">
        ...
        <main className="max-w-3xl mx-auto px-6 md:px-8 pt-32 md:pt-48">
          ...
          <section id="about" className="mb-40 scroll-mt-32">
            ...
            <div className="space-y-6 text-zinc-400 leading-relaxed font-light md:text-lg">
            ...
            <div className="space-y-4">
              {[...experience, ...hackathons].map((exp, i) => (
                <motion.div
                  ...
                  // This fixes the abrupt edge cutting and creates a floating hover card effect.
                  className="group flex flex-col md:flex-row md:items-start p-6 md:p-8 -mx-6 md:-mx-8 rounded-3xl hover:bg-zinc-900/50 border border-transparent hover:border-zinc-800/50 transition-all duration-300"
                >
                  <div className="text-xs font-semibold text-zinc-500 tracking-widest uppercase md:w-40 shrink-0 pt-1 mb-4 md:mb-0">
                    {exp.period}
                  </div>
                  <div>
              ...
              {projects.map((project, i) => (
                ...
                >
                  <div className="flex justify-between items-start mb-6">
                    ...
                    {project.github && (
                      <a href={project.github} target="_blank" rel="noreferrer" className="text-zinc-500 hover:text-zinc-100 bg-zinc-800/50 hover:bg-zinc-700 p-2 rounded-full transition-colors">
                        <ArrowUpRight size={18} className="group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform" />
                      </a>
                    )}
                  </div>

                  <p className="text-zinc-400 leading-relaxed mb-8 font-light max-w-xl">
                    {project.description}
                  </p>
