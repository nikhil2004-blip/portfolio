export const about = {
  ...
  hobbies: [
    { icon: 'heart', label: 'Gym', desc: 'Because apparently brains alone aren\'t enough.' },
    { icon: 'human-run', label: 'Cycling', desc: 'Nature\'s debugging session.' },
    { icon: 'human-run', label: 'Running', desc: 'Great for thinking. Terrible for the knees.' },
    { icon: 'tool-case', label: 'Hardware Teardowns', desc: 'If it has screws, it\'s getting opened.' },
    { icon: 'settings-cog', label: 'Mechanical Parts', desc: 'The beauty of things that actually make sense.' },
    { icon: 'gamepad', label: 'Gaming', desc: 'Done every GTA, CoD, and Hitman ever made. Professionally.' },
  ],
